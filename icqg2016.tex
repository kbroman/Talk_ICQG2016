...
\item More genomic-y things
  ...
  \item More time points, tissues, environments, treatments}
...
\bigskip \bigskip
  ...
  \onslide<4| handout:1>{\centerline{But {\hilit more} is not necessarily {\hilit better}.}}
...
\begin{frame}[c]{}
  ...
  \large \centerline{Data visualizations are critical}
...
\begin{frame}[c]{Tables suck}
  ...
  \only<1>{\figh{Figs/full_table.png}{0.8}}
  \only<2| handout:0>{\figw{Figs/table.png}{1}}
  \only<3| handout:0>{\figh{Figs/table_fig.pdf}{0.8}}
  \only<4| handout:0>{\figh{Figs/table_fig_B.pdf}{0.8}}
...
\begin{frame}{Recognize tool makers}
